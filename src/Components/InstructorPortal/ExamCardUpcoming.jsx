	...
	return (
		<div className="d-flex gap-3 p-3 text-light">
			<div className="text-uppercase bg-black bg-opacity-25 pb-1 rounded-bottom">
				...
				<h5 className="mb-0 px-3 bg_primary rounded-bottom">
					{format(new Date(data?.date), 'iii')}
				</h5>
			</div>
			...
			{type === 'instructor' && (
				<Link
					className="clickable text_primary"
					href={`/instructor-portal/exams/update-exam/${data?._id}`}
				>
